...
/** Kindle's equivalent of Aurum's <BottomSheet> — same spring slide-up, kindle-glass surface. */
export default function KindleSheet({ open, onClose, title, children }: KindleSheetProps) {
